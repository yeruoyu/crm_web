...
<c:url value="/schedule/records" var="recordsUrl" />
<html lang="en">
<head>
...
function formatEditLink(cellvalue, options, rowObject) {
    return " <a href=/crm_web/schedule/scheduleDetail?scheduleId="+ rowObject.scheduleId + ">[查看]</a>";
}
</script>
</html>