						...
						<div class="panel-body">
							...
							<form role="form" class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control" value="${customerDto.customerCode }" id="customerCode" readonly="readonly"  placeholder="Placeholder">
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control" value="${customerDto.customerName }" id="customerName" readonly="readonly"  placeholder="Placeholder">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label" for="field-1">来源渠道</label>
									<div class="col-sm-6">
										<select  id="channelCode" name="channelCode" value="${customerDto.channelCode}" class="form-control">
											<c:forEach items="${channelDtos}" var="channel">
												<c:if test="${customerDto.channelCode==channel.channelCode}">
								...
								<div class="form-group">
									<label class="col-sm-2 control-label" for="field-1">专业列表</label>
									<div class="col-sm-6">
								...
								<div class="form-group">
									<label class="col-sm-2 control-label" for="field-1">对应员工</label>
									<div class="col-sm-6">
										<input type="text" class="form-control" value="${customerDto.userName}" id="userName" readonly="readonly" placeholder="员工姓名">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-6">
										<select id="customerLocked" value="${customerDto.customerLocked}" class="form-control">
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<select id="customerStatus" value="${customerDto.customerStatus}" class="form-control" disabled="disabled">
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<textarea class="form-control" id="customerComments">${customerDto.customerComments}</textarea>
									</div>
								</div>
							</form>
						</div>
