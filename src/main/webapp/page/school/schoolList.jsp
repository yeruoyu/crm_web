...
<c:url value="/school/records" var="recordsUrl" />
<c:url value="/school/create" var="addUrl" />
<c:url value="/school/update" var="editUrl" />
<c:url value="/school/delete" var="deleteUrl" />
			...
			<div class="page-title">
				<div class="breadcrumb-env">
					<ol class="breadcrumb bc-1">
						...
						<li><a href="<c:url value='/project/projectList'/>">学校管理</a>
						</li>
