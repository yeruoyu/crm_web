...
<!-- 角色信息 -->
<c:url value="/role/saveNewRole" var="saveNewRole"/>
						...
						<div class="panel-body">
							...
							<form role="form" id="roleForm" class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control" value="${roleDto.roleCode }" id="roleCode" name="roleCode" placeholder="角色Code">
									</div>
								</div>
								<div class="form-group">
